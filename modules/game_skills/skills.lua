...
function init()
  ...
  skillsButton = modules.client_topmenu.addRightGameToggleButton('skillsButton', tr('Skills') .. ' (Ctrl+Z)', '/images/topbuttons/skills', toggle)
...
function refresh()
  ...
  skillsWindow:setContentMaximumHeight(303)
end
...
function onSoulChange(localPlayer, soul)
  --setSkillValue('soul', soul), tira soul da visão.
end
...
function onStaminaChange(localPlayer, stamina)
  ...
  setSkillPercent('stamina', percent, tr('You have %s percent. You receive more experience with 40:00+ stamina.', percent))
end
