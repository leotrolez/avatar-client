...
function init()
    --:(
	g_keyboard.bindKeyDown('CTRL+SHIFT+R', toggle)
			  connect(g_game, {changeMount = toggle})
end
...
--        g_game.talk("!mount none")
        ...
        mountWindow = g_ui.loadUI('game_mountsChange', rootWidget)
