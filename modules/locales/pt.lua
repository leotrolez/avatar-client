locale = {
  ...
  translation = {
    ["For some reason you are unable to log in,\ncheck your internet connection and make sure the\nserver is online. If the server is online and your\ninternet connection is normal, we suggest\nre-downloading the client to remedy the problem."] = "Por algum motivo você não está conseguindo entrar\nno servidor, verifique sua conexão com a internet e\ncertifique-se de que o servidor está online. Caso o\nservidor esteja online e sua conexão com a internet esteja\nnormal, sugerimos refazer o download do client\npara sanar o problema.",
    ...
    ["Alas! Brave adventurer, you have met a sad fate.\nBut do not despair, for the gods will bring you back\ninto this world in exchange for a small sacrifice\n\nSimply click on Ok to resume your journeys!"] = "Aventureiro corajoso, você encontrou um destino\ntriste. Mas não se desespere, pois os deuses o\ntrarão de volta neste mundo em troca de um\npequeno sacrifício.\n\nBasta clicar em 'Ok' para retomar suas viagens!",
    ...
    ["Battle"] = "Batalha",
    ["Battle (Ctrl+B)"] = "Batalha (Ctrl+B)",
    ["Browse"] = "Navegar",
    ["Bug report sent."] = "Reporte de bug enviado.",
    ["Report sent."] = "Reporte enviado. Obrigado!",
    ["Report"] = "Reportar",
    ["Please use this dialog to report bugs or players."] = "Relate para nós qual erro você encontrou no jogo. Você também pode reportar algum jogador por mal conduta ou uso de programas ilegais por aqui.",
    ...
    ["Detail"] = "Detalhe",
    ["Details"] = "Detalhes",
    ["Disable/Enable folds"] = "Desabilitar/Habilitar dobras",
    ["Disable Shared Experience"] = "Desativar experiência compartilhada",
    ["Disable chat mode, allow to walk using ASDW/QEZC\nPress Ctrl+Enter to disable\nIf the chat is closed, you can attack the monsters with the TAB key"] = "Desativar o bate-papo permite andar usando ASDW/QEZC\nPressione Ctrl+Enter para desabilitar\nCaso o bate-papo esteja desabilitado, utilize TAB para atacar monstros próximos",
    ["Dismount"] = "Desmontar",
    ...
    ["Enter one name per line."] = "Somente um nome por linha.",
    ...
    ["Find"] = "Procurar",
    ["Fishing"] = "Pesca",
    ["Fist Fighting"] = "Combate sem Armas",
    ["Follow"] = "Seguir",
    ["Information:"] = "Informações:",
    ["Informations:"] = "Informações:",
    ["Force Exit"] = "Sair Agora",
    ["Formula"] = "Fórmula",
    ...
    ["Hold left mouse button to navigate\nScroll mouse middle button to zoom\nRight mouse button to create map marks\nPress Ctrl+Shilft+M to view the entire game map"] = "Segure o botão esquerdo para navegar\nGire o botão do centro do mouse para ampliar\nClique com o botão direito do mouse para criar marcas\nPressione Ctrl+Shilft+M para ver o mapa completo",
    ["Host"] = "Host",
    ["Hotkeys"] = "Atalhos",
    ...
    ["Please enter a character name:"] = "Entre com o nome do personagem:",
    ...
    ["Premium Account - %s day(s) left"] = "Premium Account - %s day(s) left",
    ["Premium"] = "Premium",
    ["Price"] = "Preço",
    ["Primary"] = "Primário",
    ["Protocol"] = "Protocolo",
    ...
    ["You can enter new text."] = "Você pode escrever um novo texto.",
	...
	["You have %s percent. You receive more experience with 40:00+ stamina."] = "Você tem %s porcento. Você recebe um pouco mais de experiência com stamina acima de 40:00.", 
    ["You may not logout during a fight"] = "Você não pode sair durante um combate",
    ["Show your character element emblem"] = "Mostrar o elemento de seu personagem",
    ["You need to relog to update your element emblem."] = "Você precisa relogar para atualizar o seu emblema.",
    ...
    ["You read the following, written by %s\n"] = "Você lê o seguinte, escrito por %s\n",
	...
	["With inactive PvP you can not attack nor be attacked by other players. \n You also lose your 30% bonus experience."] = "Com PvP inativo você não poderá atacar e nem ser atacado por outros jogadores. \n Você também perderá seus 30% de experiência bônus (concedido pelo ativo)",
	["With active PvP you can attack and be attacked by other players. \n You will also receive 30% bonus experience by defeating monsters."] = "Com PvP ativo você poderá atacar e ser atacado por outros jogadores. \n Você também receberá 30% de experiência bônus derrotando monstros.",
	["Active"] = "Ativo",
	["Inactive"] = "Inativo",
	["With inactive PvP you can not attack nor be attacked by other players."] = "Com PvP inativo você não poderá atacar e nem ser atacado por outros jogadores.",
	["You also lose your 30% bonus experience."] = "Você também perderá sua experiência bônus (concedido pelo ativo).",
	["With active PvP you can attack and be attacked by other players."] = "Com PvP ativo você poderá atacar e ser atacado por outros jogadores.",
	["You will also receive 30% bonus experience by defeating monsters."] = "Você também receberá experiência bônus derrotando monstros.",
	["Total price:"] = "Preço total:",
	["Transaction ID:"] = "ID da Transação:",
	["Bend List"] = "Dobras",
	["Quick Looting"] = "Loot automático",
	["Bend List (Ctrl F)"] = "Dobras (Ctrl+F)",
    ["Shrink game window"] = "Encolher janela do jogo (necessário relogar)",
    ["Stats"] = "Status",
    ["Easy Hunts (!help)"] = "Hunts Iniciais (!help)",
    ["more"] = "outros"
  }
}
