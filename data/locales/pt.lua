locale = {
  ...
  translation = {
	...
	["You have %s percent. You receive more experience with 40:00+ stamina (premium only)."] = "Você tem %s porcento. Você recebe mais experiência com stamina acima de 40:00 (caso você seja premium).", 
